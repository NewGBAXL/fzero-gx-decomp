...
[![Build](https://github.com/karamzov123/fzero-gx-decomp/actions/workflows/report.yml/badge.svg?style=flat-square)](https://github.com/karamzov123/fzero-gx-decomp/actions/workflows/report.yml) [![Code Progress](https://decomp.dev/karamzov123/fzero-gx-decomp.svg?mode=shield&measure=code&label=Code)](https://decomp.dev/karamzov123/fzero-gx-decomp) [![Data Progress](https://decomp.dev/karamzov123/fzero-gx-decomp.svg?mode=shield&measure=data&label=Data)](https://decomp.dev/karamzov123/fzero-gx-decomp) [![Game ID](https://img.shields.io/badge/Game%20ID-GFZE01-21262d?style=flat-square)](config/GFZE01) [![Platform](https://img.shields.io/badge/Platform-GameCube-21262d?style=flat-square)](docs/getting_started.md) [![Region](https://img.shields.io/badge/Region-NTSC--U-21262d?style=flat-square)](config/GFZE01)
...
Progress is published through the GitHub Actions `GFZE01_report` artifact and tracked on [decomp.dev](https://decomp.dev/karamzov123/fzero-gx-decomp), which reports the standard objdiff measures: matched code and matched data against `main.dol`.
...
This covers the public build/report tooling in `tools/`. It does not build or
verify the DOL — that requires the legally obtained matching inputs and
